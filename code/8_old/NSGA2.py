...
class NSGA2(object):
    ...
    def nsga2(problem = DTLZ1, pop_size=100, gens=250, mutation=0.01, crossover_rate=0.9,  dom_func=bdom):
        ...
        children = reproduce(problem,pop_size,mutation,crossover_rate)
        gen = 0
